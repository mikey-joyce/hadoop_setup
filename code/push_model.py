...
def push_model_and_tokenizer(checkpoint_path, repo_id, commit_message=None):
    ...
    # push tokenizer
    tokenizer = AutoTokenizer.from_pretrained(f"{checkpoint_path}/tokenizer.json") 
...
if __name__ == "__main__":
    ...
    path = "~/ray_results/zayanhugsAI/twitter_roberta_finetuned/TorchTrainer_f0b32_00000_0_2025-05-06_02-00-52/checkpoint_000002/checkpoint"
